...
class Viola(private val faceDetectionListener: FaceDetectionListener,context: Context) {
    ...
    init {
        val options = FaceDetectorOptions.Builder()
            ...
            .build()
        imageProcessor = FaceDetectorProcessor(options, faceDetectionListener,context)
    }
