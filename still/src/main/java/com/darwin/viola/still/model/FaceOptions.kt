...
class FaceOptions private constructor(builder: Builder) {
    ...
    val genderClassification : Boolean
    val debug: Boolean
    ...
    init {
        ...
        this.genderClassification = builder.genderClassification
    ...
    class Builder {
        ...
        var ageClassification: Boolean = false
            private set
        var genderClassification: Boolean = false
            private set
        ...
        fun enableGenderClassification() = apply { this.genderClassification = true }
